    ...
    stage('Start onboarding-server for Performance/Integration Testing'){
      ...
      steps{
        ...
        script{
            ...
            sh 'mvn test-compile failsafe:integration-test -DskipUnitTests=true -DintTestProxyHost=jenkins-master-priv -DintTestProxyPort=8090 -DintTestHost=jenkins-slave1 -DintTestPort=8090'
        }
        node('built-in') {
          script{
            runZapAttack()
