pipeline {
  ...
  stages {
    ...
    stage('Unit Tests and Code Coverage Test'){
      steps{
        script{
          sh 'cp /home/ubuntu/configs/5.6.0/onboarding-config-test.json ./secrets/all-verticles-configs/config-test.json'
    ...
    stage('Integration Tests and OWASP ZAP pen test'){
      steps{
        ...
        script{
            sh 'mkdir configs'
            sh 'cp /home/ubuntu/configs/5.6.0/onboarding-config-test.json ./configs/config-test.json'
